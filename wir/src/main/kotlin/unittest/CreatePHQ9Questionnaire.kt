...
suspend fun main(args: Array<String>) {
    ...
    val answer = PHQ9Answer.Builder()
        ...
        .answer8(FeelingLevel.MORE_THAN_HALF)
        .answer9(FeelingLevel.ALMOST_EVERYDAY)
        .build()

    questionnaireDataSource.createPHQ9Answer(unixTimestampSeconds.toInt(), answer)
}